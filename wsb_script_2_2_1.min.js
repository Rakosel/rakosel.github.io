var ra,rs,lines_in,i,url,maOBJ,seOBJ,bmeOBJ,sds,mds,sets,stopAll=!1,subwdeb=!1,str_out="",str_out1="",uart_json={},temp_json={},input_lm75={},scrPos=0,ovShBtn0=!1,ast=0,ua_mode=0,tmranim=5000;sds=$(".sideset");mds=$(".macnt");sets=$(".setcnt");cnftmp=$(".scntf");function btn_otp_wr(){var b="/otp_mode?input="+encodeURIComponent("Wr345")+"&";fetch(b,"GET",txjstmp,30)}
