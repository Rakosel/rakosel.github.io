// upd80a3 STABLE trim with upravl timer	https://rakosel.github.io/wsb_script_2_2_1.js
// 682 stroka trim ???
// except (
    ...
    if (temp_json["temp"]) {
        ...
        for (i = 0; i <= temp_arr.length; i++) {
            //try {
				...
				{
					j_T+=parseFloat(temp_arr[i]);T_cnt++; console.log(+"a5 "+parseFloat(temp_arr[i])+" "+T_cnt," "+temp_arr[i]);
				}
