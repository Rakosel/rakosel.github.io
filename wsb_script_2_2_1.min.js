...
function btn_sht30_1_Wr(){var a=$("#sht30_ht option:selected").val(),g=$("#sht30_m option:selected").val(),c=$("#sht30_scr option:selected").val(),e=$("#sht30_rep option:selected").val(),b=$("#sht30_mps_sel option:selected").val();$(".btns_sht30").removeClass("badge-success");$(".btns_sht30").removeClass("badge-danger");input_sht30={sht30_conf:[a,g,c,e,b]};fetch("/input_sht30_1.json?n="+encodeURIComponent(JSON.stringify(input_sht30))+"&","GET",txjstmp,10)}
function btn_sht30_2_Wr(){var a=$("#sht31_ht option:selected").val(),g=$("#sht31_m option:selected").val(),c=$("#sht31_scr option:selected").val(),e=$("#sht31_rep option:selected").val(),b=$("#sht31_mps_sel option:selected").val();$(".btns_sht31").removeClass("badge-success");$(".btns_sht31").removeClass("badge-danger");input_sht31={sht31_conf:[a,g,c,e,b]};fetch("/input_sht30_2.json?n="+encodeURIComponent(JSON.stringify(input_sht31))+"&","GET",txjstmp,10)}
...
function btn_bm280_1_Wr(){var a=$("#bm1s_m option:selected").val(),g=$("#bm1s_osrs option:selected").val(),c=$("#bm1s_f option:selected").val(),e=$("#bm1_t_st option:selected").val(),b=$("#bm_alt").val();$(".btns_bme280_1").removeClass("badge-success");$(".btns_bme280_1").removeClass("badge-danger");0==$.isNumeric(b)?$(".btns_bme280_1").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 (\u0441\u043c\u043e\u0442\u0440\u0438 \u0432\u044b\u0448\u0435)"):(input_bme280={bme280_conf:[a,
g,c,e,b]},fetch("/input_bme280_1.json?n="+encodeURIComponent(JSON.stringify(input_bme280))+"&","GET",txjstmp,10))}
function btn_bm280_2_Wr(){var a=$("#bm2s_m option:selected").val(),g=$("#bm2s_osrs option:selected").val(),c=$("#bm2s_f option:selected").val(),e=$("#bm2_t_st option:selected").val(),b=$("#bm_alt").val();$(".btns_bme280_2").removeClass("badge-success");$(".btns_bme280_2").removeClass("badge-danger");0==$.isNumeric(b)?$(".btns_bme280_2").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 (\u0441\u043c\u043e\u0442\u0440\u0438 \u0432\u044b\u0448\u0435)"):(input_bme280={bme280_conf:[a,
g,c,e,b]},fetch("/input_bme280_2.json?n="+encodeURIComponent(JSON.stringify(input_bme280))+"&","GET",txjstmp,10))}function btn_bm280_1_Rd(){$(".btns_bme280_1").removeClass("badge-success");$(".btns_bme280_1").removeClass("badge-danger");fetch("/output_bme280_1.json?n="+Math.random(),"GET",txjstmp,10)}function btn_bm280_2_Rd(){$(".btns_bme280_2").removeClass("badge-success");$(".btns_bme280_2").removeClass("badge-danger");fetch("/output_bme280_2.json?n="+Math.random(),"GET",txjstmp,10)}
function txjstmp(a,g){var c=$(".pst1"),e=$(".pst0"),b=0,d=0,k=0,n=1,p=1,q=1;if(200!=a)return e.removeClass("badge-success"),e.addClass("badge-danger"),e.text("\u041d\u0435\u0442 \u0441\u0432\u044f\u0437\u0438"),c.removeClass("badge-success"),c.addClass("badge-danger"),c.text("\u041d\u0435\u0442 \u0441\u0432\u044f\u0437\u0438"),$(".swdeb").removeAttr("disabled"),ftmpd(),console.log("Connection proplem!"),0;e.removeClass("badge-danger");c.removeClass("badge-danger");e.addClass("badge-success");c.addClass("badge-success");
e.text("\u041e\u041a ");c.text("\u041e\u041a ");if("string"===typeof g)try{temp_json=JSON.parse(g),console.log(a,temp_json)}catch(m){return ftvall(""),console.log(a,m.message),0}else return console.log("d not string"),ftvall(""),0;if(temp_json.LM75_CMP)try{var f=parseInt(temp_json.LM75_CMP[0].trim(),10),h=parseInt(temp_json.LM75_CMP[1].trim(),10);1==f?$("#lm75_t1_chk").prop("checked",!0):$("#lm75_t1_chk").prop("checked",!1);1==h?$("#lm75_t2_chk").prop("checked",!0):$("#lm75_t2_chk").prop("checked",
!1)}catch(m){console.log(m)}temp_json.lm_75_1_cb&&("OK"==temp_json.lm_75_1_cb?$(".btns_lm75_1").addClass("badge-success").text("\u041e\u041a "):$(".btns_lm75_1").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 "));if(temp_json.lm75_1_ou)if(999!=parseInt(temp_json.lm75_1_ou[1].trim(),10)||999!=parseInt(temp_json.lm75_1_ou[0].trim(),10)){f=parseInt(temp_json.lm75_1_ou[1].trim(),10);h=parseInt(temp_json.lm75_1_ou[2].trim(),10);$(".lm75thy_1").text(f+" \u00b0C");$(".lm75tos_1").text(h+
" \u00b0C");$("#lm75sc_1").val(f);$("#lm75so_1").val(h);e=parseInt(temp_json.lm75_1_ou[0].trim(),10);if($.isNumeric(e))for(f=0;4>=f;f++)e&1<<f?$("#gLM75ch"+f.toString()).prop("checked",!0):$("#gLM75ch"+f.toString()).prop("checked",!1);$(".btns_lm75_1").addClass("badge-success").text("\u041e\u041a ")}else $(".btns_lm75_1").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 ");if(temp_json.lm75_2_ou)if(999!=parseInt(temp_json.lm75_2_ou[1].trim(),10)||999!=parseInt(temp_json.lm75_2_ou[0].trim(),
10)){f=parseInt(temp_json.lm75_2_ou[1].trim(),10);h=parseInt(temp_json.lm75_2_ou[2].trim(),10);$(".lm75thy_2").text(f+"\u00b0C");$(".lm75tos_2").text(h+"\u00b0C");$("#lm75sc_2").val(f);$("#lm75so_2").val(h);e=parseInt(temp_json.lm75_2_ou[0].trim(),10);if($.isNumeric(e))for(f=0;4>=f;f++)e&1<<f?$("#gLM752ch"+f.toString()).prop("checked",!0):$("#gLM752ch"+f.toString()).prop("checked",!1);$(".btns_lm75_2").addClass("badge-success").text("\u041e\u041a ")}else $(".btns_lm75_2").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 ");
...
$("#bm1_st").val("\u041e\u0448\u0438\u0431\u043a\u0430"),$(".btns_bme280_1").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 ");temp_json.bme280_2_ou&&(999!=parseInt(temp_json.bme280_2_ou[1],10)||999!=parseInt(temp_json.bme280_2_ou[0].trim(),10)?($("#bm2_ch").val("0x"+Number(temp_json.bme280_2_ou[0]).toString(16).toUpperCase().trim()),e=parseInt(temp_json.bme280_2_ou[1],10),$("#bm2_st").val("0x"+Number(temp_json.bme280_2_ou[1]).toString(16).toUpperCase().trim()),$.isNumeric(e)&&
(e&1?($("#gBM2802ch0").prop("checked",!0),console.log("#gBM2802ch0 true "+e)):($("#gBM2802ch0").prop("checked",!1),console.log("#gBM2802ch0 false "+e)),l&8?$("#gBM2802ch3").prop("checked",!0):$("#gBM2802ch3").prop("checked",!1),$("#bm2s_m option").removeProp("selected"),$("#bm2s_osrs option").removeProp("selected"),$("#bm2s_f option").removeProp("selected"),$("#bm2_t_st option").removeProp("selected"),$("#bm2s_m [value="+temp_json.bme280_2_ou[2]+"]").prop("selected","selected"),$("#bm2s_osrs [value="+
temp_json.bme280_2_ou[3]+"]").prop("selected","selected"),$("#bm2s_f [value="+temp_json.bme280_2_ou[4]+"]").prop("selected","selected"),$("#bm2_t_st [value="+temp_json.bme280_2_ou[5]+"]").prop("selected","selected"),$(".btns_bme280_2").addClass("badge-success").text("\u041e\u041a "))):($("#bm2_ch").val("\u041e\u0448\u0438\u0431\u043a\u0430"),$("#bm2_st").val("\u041e\u0448\u0438\u0431\u043a\u0430"),$(".btns_bme280_2").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 ")));if(temp_json.temp){for(f=
3;f<=maOBJ.length&&f-3<=temp_json.temp.length;f++)"#ERR"==temp_json.temp[f-3]||""==temp_json.temp[f-3]||temp_json.temp[f-3]==isNaN()?tmpvloff(f):tmpvlon(f),$("#"+maOBJ[f].name).val(temp_json.temp[f-3]);for(f=0;f<=temp_json.temp.length;f++)if("#ERR"!=temp_json.temp[f]||""!=temp_json.temp[f]||temp_json.temp[f]!=isNaN())jT<=T_arr.length&&(b+=temp_json.temp[0],n++),jH<=H_arr.length&&(d+=temp_json.temp[0],p++),jP<=P_arr.length&&(k+=temp_json.temp[0],q++);$("#temperature").val(b/n);$("#humudity").val(d/
p);$("#pressure").val(k/q)}$("#tm_adc").removeClass("is-invalid").html();$("#tm_adc").removeClass("is-valid").html();temp_json.temt_adc&&($("#tm_adc").val(temp_json.temt_adc),""==temp_json.temt_adc||temp_json.temt_adc==isNaN()?$("#tm_adc").addClass("is-invalid").html():$("#tm_adc").addClass("is-valid").html());d=parseFloat($("#htu21_t").val());b=parseFloat($("#htu21_h").val());k=1.359*Math.pow(10,8)*Math.pow(10,-1762.39/(d+235.66));d=(133.32*k/1E3).toString();$("#htu21_pp").val(d.substring(0,5));
b=(-(1762.39/(Math.log(.01*b*k)-8.1332)+235.66)).toString();$("#htu21_dew").val(b.substring(0,5));if("NaN"==d||"NaN"==b||""==d||""==b)$("#htu21_dew").removeClass("is-invalid").html(),$("#htu21_dew").removeClass("is-valid").html(),$("#htu21_dew").addClass("is-invalid").html(),$("#htu21_pp").removeClass("is-invalid").html(),$("#htu21_pp").removeClass("is-valid").html(),$("#htu21_pp").addClass("is-invalid").html();$("#htu21_dew").removeClass("is-invalid").html();$("#htu21_dew").removeClass("is-valid").html();
$("#htu21_dew").addClass("is-valid").html();$("#htu21_pp").removeClass("is-invalid").html();$("#htu21_pp").removeClass("is-valid").html();$("#htu21_pp").addClass("is-valid").html();temp_json.debug&&(console.log(temp_json.debug),"ON"==temp_json.debug?(sdmc_sh(),c.removeClass("badge-warning"),c.addClass("badge-success"),c.text("\u0412\u041a\u041b")):"OFF"==temp_json.debug?(sdmc_rm(),c.removeClass("badge-success"),c.addClass("badge-warning"),c.text("\u0412\u042b\u041a\u041b")):(c.removeClass("badge-success"),
c.addClass("badge-danger"),c.text("\u041d\u0415\u0422 \u0421\u0412\u042f\u0417\u0418")),$(".swdeb").removeAttr("disabled"));if(temp_json.rtc_get){f=0;for(f in temp_json.rtc_get)str_out+=temp_json.rtc_get[f]+"-";$(".ptime").text(str_out.substring(0,str_out.length-1))}str_out=""}function tmpvlon(a){$("#"+maOBJ[a].name).removeClass("is-invalid").html();$("#"+maOBJ[a].name).removeClass("is-valid").html();$("#"+maOBJ[a].name).addClass("is-valid").html()}
function tmpvloff(a){$("#"+maOBJ[a].name).removeClass("is-invalid").html();$("#"+maOBJ[a].name).removeClass("is-valid").html();$("#"+maOBJ[a].name).addClass("is-invalid").html()}function sdmc_sh(){mds.removeClass("collapse show");mds.addClass("collapse hide");sds.removeClass("collapse hide");sds.addClass("collapse show");sets.removeClass("collapse hide");sets.addClass("collapse show")}
function sdmc_rm(){mds.removeClass("collapse hide");mds.addClass("collapse show");sds.removeClass("collapse show");sds.addClass("collapse hide");sets.removeClass("collapse show");sets.addClass("collapse hide")}function ftvall(a){for(i=0;i<maOBJ.length;i++)$("#"+maOBJ[i].name).val(a),$("#"+maOBJ[i].name).removeClass("is-invalid").html(),$("#"+maOBJ[i].name).removeClass("is-valid").html()}
...
function fetch(a,g,c,e){console.log(a);var b=new XMLHttpRequest;b.onloadend=function(){c(b.status,b.responseText)};b.ontimeout=function(){c(-1,null)};b.open(g,a,!0);b.setRequestHeader("Accept","application/json");b.timeout=200*e;b.send()}function btn_lm75_1s(){$(".btns_lm75_1").removeClass("badge-danger");$(".btns_lm75_1").removeClass("badge-success");fetch("/output_lm75_1.json?n="+Math.random(),"GET",txjstmp,10)}
...
function btn_lm75_1(){var a,g=0,c=$("#lm75sc_1"),e=$("#lm75so_1");for(a=0;5>a&&void 0!=$("#gLM75ch"+a).val();++a)$("#gLM75ch"+a).prop("checked")&&(g|=1<<a);var b=c.val();var d=e.val();console.log(b+" "+d);d>b&&0>d&&0>b?(b=d=b,console.log("thyst1>tos1 && (thyst1<0) && (tos1<0)"+b+" "+d)):d>b&&(a=d,d=b,b=a,console.log("thyst1>tos1"+b+" "+d));b==d&&(0>d&&0>b?d--:b++);c.val(d);e.val(b);$(".lm75thy_1").text(c.val()+" C\u00b0");$(".lm75tos_1").text(e.val()+" C\u00b0");d=parseInt(c.val());b=parseInt(e.val());
...
function btn_lm75_2(){var a,g=0,c=$("#lm75sc_2"),e=$("#lm75so_2");for(a=0;5>a&&void 0!=$("#gLM752ch"+a).val();++a)$("#gLM752ch"+a).prop("checked")&&(g|=1<<a);var b=c.val();var d=e.val();console.log(b+" "+d);d>b&&0>d&&0>b?(b=d=b,console.log("thyst1>tos1 && (thyst1<0) && (tos1<0)"+b+" "+d)):d>b&&(a=d,d=b,b=a,console.log("thyst1>tos1"+b+" "+d));b==d&&(0>d&&0>b?d--:b++);c.val(d);e.val(b);$(".lm75thy_2").text(c.val()+" C\u00b0");$(".lm75tos_2").text(e.val()+" C\u00b0");d=parseInt(c.val());b=parseInt(e.val());
...
function txjs_ua(a,g){seOBJ=$("#scntf").serializeArray();$("#btn1").prop("disabled",!1);if(200!=a)str_out1+="Send command error\n",console.log("Connection proplem!");else{if("string"===typeof g){console.log("priem ok!");try{uart_json=JSON.parse(g)}catch(e){return console.log(e),0}}else uart_json.uart_out="null",uart_json.uart_in="null";console.log(uart_json);str_out1=""==uart_json.uart_out?str_out1+"ACK\n":str_out1+(uart_json.uart_out+"\n")}var c=$("#esp_urx");""!=c.val()?c.val(c.val()+str_out1):
