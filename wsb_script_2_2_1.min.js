var stopAll=!1,ra,rs,subwdeb=!1,lines_in,i,url,maOBJ,seOBJ,bmeOBJ,str_out="",str_out1="",uart_json={},temp_json={},input_lm75={},scrPos=0,ovShBtn0=!1,ast=0,ua_mode=0,tmranim=2E3,T_arr=[],P_arr=[],H_arr=[],temp_arr=[];T_arr=[0,1,2,4,5,16,17,20];H_arr=[3,8,9,18,19,21];P_arr=[6,7,12,13];var sds,mds,sets;sds=$(".sideset");mds=$(".macnt");sets=$(".setcnt");cnftmp=$(".scntf");function btn_otp_wr(){var b="/otp_mode?input="+encodeURIComponent("Wr345")+"&";fetch(b,"GET",txjstmp,30)}
...
function btn_sht30_1_Wr(){var b=$("#sht30_ht option:selected").val(),g=$("#sht30_m option:selected").val(),d=$("#sht30_scr option:selected").val(),e=$("#sht30_rep option:selected").val(),a=$("#sht30_mps_sel option:selected").val();$(".btns_sht30").removeClass("badge-success");$(".btns_sht30").removeClass("badge-danger");input_sht30={sht30_conf:[b,g,d,e,a]};fetch("/input_sht30_1.json?n="+encodeURIComponent(JSON.stringify(input_sht30))+"&","GET",txjstmp,10)}
function btn_sht30_2_Wr(){var b=$("#sht31_ht option:selected").val(),g=$("#sht31_m option:selected").val(),d=$("#sht31_scr option:selected").val(),e=$("#sht31_rep option:selected").val(),a=$("#sht31_mps_sel option:selected").val();$(".btns_sht31").removeClass("badge-success");$(".btns_sht31").removeClass("badge-danger");input_sht31={sht31_conf:[b,g,d,e,a]};fetch("/input_sht30_2.json?n="+encodeURIComponent(JSON.stringify(input_sht31))+"&","GET",txjstmp,10)}
...
function btn_bm280_1_Wr(){var b=$("#bm1s_m option:selected").val(),g=$("#bm1s_osrs option:selected").val(),d=$("#bm1s_f option:selected").val(),e=$("#bm1_t_st option:selected").val(),a=$("#bm_alt").val();$(".btns_bme280_1").removeClass("badge-success");$(".btns_bme280_1").removeClass("badge-danger");0==$.isNumeric(a)?$(".btns_bme280_1").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 (\u0441\u043c\u043e\u0442\u0440\u0438 \u0432\u044b\u0448\u0435)"):(input_bme280={bme280_conf:[b,
g,d,e,a]},fetch("/input_bme280_1.json?n="+encodeURIComponent(JSON.stringify(input_bme280))+"&","GET",txjstmp,10))}
function btn_bm280_2_Wr(){var b=$("#bm2s_m option:selected").val(),g=$("#bm2s_osrs option:selected").val(),d=$("#bm2s_f option:selected").val(),e=$("#bm2_t_st option:selected").val(),a=$("#bm_alt").val();$(".btns_bme280_2").removeClass("badge-success");$(".btns_bme280_2").removeClass("badge-danger");0==$.isNumeric(a)?$(".btns_bme280_2").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 (\u0441\u043c\u043e\u0442\u0440\u0438 \u0432\u044b\u0448\u0435)"):(input_bme280={bme280_conf:[b,
g,d,e,a]},fetch("/input_bme280_2.json?n="+encodeURIComponent(JSON.stringify(input_bme280))+"&","GET",txjstmp,10))}function btn_bm280_1_Rd(){$(".btns_bme280_1").removeClass("badge-success");$(".btns_bme280_1").removeClass("badge-danger");fetch("/output_bme280_1.json?n="+Math.random(),"GET",txjstmp,10)}function btn_bm280_2_Rd(){$(".btns_bme280_2").removeClass("badge-success");$(".btns_bme280_2").removeClass("badge-danger");fetch("/output_bme280_2.json?n="+Math.random(),"GET",txjstmp,10)}
function txjstmp(b,g){var d=$(".pst1"),e=$(".pst0"),a=0,f=0,h=0,m=0,n=0,p=0;if(200!=b)return e.removeClass("badge-success"),e.addClass("badge-danger"),e.text("\u041d\u0435\u0442 \u0441\u0432\u044f\u0437\u0438"),d.removeClass("badge-success"),d.addClass("badge-danger"),d.text("\u041d\u0435\u0442 \u0441\u0432\u044f\u0437\u0438"),$(".swdeb").removeAttr("disabled"),ftmpd(),0;e.removeClass("badge-danger");d.removeClass("badge-danger");e.addClass("badge-success");d.addClass("badge-success");e.text("\u041e\u041a ");
d.text("\u041e\u041a ");if("string"===typeof g)try{temp_json=JSON.parse(g)}catch(q){return ftvall(""),0}else return ftvall(""),0;if(temp_json.LM75_CMP)try{var c=parseInt(temp_json.LM75_CMP[0].trim(),10),k=parseInt(temp_json.LM75_CMP[1].trim(),10);1==c?$("#lm75_t1_chk").prop("checked",!0):$("#lm75_t1_chk").prop("checked",!1);1==k?$("#lm75_t2_chk").prop("checked",!0):$("#lm75_t2_chk").prop("checked",!1)}catch(q){}temp_json.lm_75_1_cb&&("OK"==temp_json.lm_75_1_cb?$(".btns_lm75_1").addClass("badge-success").text("\u041e\u041a "):
$(".btns_lm75_1").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 "));if(temp_json.lm75_1_ou)if(999!=parseInt(temp_json.lm75_1_ou[1].trim(),10)||999!=parseInt(temp_json.lm75_1_ou[0].trim(),10)){c=parseInt(temp_json.lm75_1_ou[1].trim(),10);k=parseInt(temp_json.lm75_1_ou[2].trim(),10);$(".lm75thy_1").text(c+" \u00b0C");$(".lm75tos_1").text(k+" \u00b0C");$("#lm75sc_1").val(c);$("#lm75so_1").val(k);e=parseInt(temp_json.lm75_1_ou[0].trim(),10);if($.isNumeric(e))for(c=0;4>=c;c++)e&1<<
c?$("#gLM75ch"+c.toString()).prop("checked",!0):$("#gLM75ch"+c.toString()).prop("checked",!1);$(".btns_lm75_1").addClass("badge-success").text("\u041e\u041a ")}else $(".btns_lm75_1").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 ");if(temp_json.lm75_2_ou)if(999!=parseInt(temp_json.lm75_2_ou[1].trim(),10)||999!=parseInt(temp_json.lm75_2_ou[0].trim(),10)){c=parseInt(temp_json.lm75_2_ou[1].trim(),10);k=parseInt(temp_json.lm75_2_ou[2].trim(),10);$(".lm75thy_2").text(c+"\u00b0C");
$(".lm75tos_2").text(k+"\u00b0C");$("#lm75sc_2").val(c);$("#lm75so_2").val(k);e=parseInt(temp_json.lm75_2_ou[0].trim(),10);if($.isNumeric(e))for(c=0;4>=c;c++)e&1<<c?$("#gLM752ch"+c.toString()).prop("checked",!0):$("#gLM752ch"+c.toString()).prop("checked",!1);$(".btns_lm75_2").addClass("badge-success").text("\u041e\u041a ")}else $(".btns_lm75_2").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 ");temp_json.lm_75_2_cb&&("OK"==temp_json.lm_75_2_cb?$(".btns_lm75_2").addClass("badge-success").text("\u041e\u041a "):
...
($("#bm2_ch").val("\u041e\u0448\u0438\u0431\u043a\u0430"),$("#bm2_st").val("\u041e\u0448\u0438\u0431\u043a\u0430"),$(".btns_bme280_2").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 ")));if(temp_json.temp){for(c=3;c<=maOBJ.length&&c-3<=temp_json.temp.length;c++)"#ERR"==temp_json.temp[c-3]||""==temp_json.temp[c-3]||NaN==temp_json.temp[c-3]?tmpvloff(c):tmpvlon(c),$("#"+maOBJ[c].name).val(temp_json.temp[c-3]),temp_arr[c-3]=parseFloat(temp_json.temp[c-3]);for(c=0;c<temp_arr.length;c++)c<
T_arr.length&&NaN!=parseFloat(temp_arr[T_arr[c]])&&(a+=Math.abs(parseFloat(temp_arr[T_arr[c]])),m++),c<H_arr.length&&NaN!=parseFloat(temp_arr[H_arr[c]])&&(f+=parseFloat(temp_arr[H_arr[c]]),n++),c<P_arr.length&&NaN!=parseFloat(temp_arr[P_arr[c]])&&(h+=parseFloat(temp_arr[P_arr[c]]),p++);a/=m;f/=n;h/=p;tmpvloff(0);tmpvloff(1);tmpvloff(2);NaN==a?tmpvloff(0):tmpvlon(0);NaN==h?tmpvloff(1):tmpvlon(1);NaN==f?tmpvloff(2):tmpvlon(2);$("#temperature").val(a.toString().substring(0,6));$("#humudity").val(f.toString().substring(0,
6));$("#pressure").val(h.toString().substring(0,6))}$("#tm_adc").removeClass("is-invalid").html();$("#tm_adc").removeClass("is-valid").html();temp_json.temt_adc&&($("#tm_adc").val(temp_json.temt_adc),""==temp_json.temt_adc||"#ERR"==temp_json.temt_adc?$("#tm_adc").addClass("is-invalid").html():$("#tm_adc").addClass("is-valid").html());f=parseFloat($("#htu21_t").val());a=parseFloat($("#htu21_h").val());h=1.359*Math.pow(10,8)*Math.pow(10,-1762.39/(f+235.66));f=(133.32*h/1E3).toString();$("#htu21_pp").val(f.substring(0,
5));a=(-(1762.39/(Math.log(.01*a*h)-8.1332)+235.66)).toString();$("#htu21_dew").val(a.substring(0,5));if("NaN"==f||"NaN"==a||""==f||""==a)$("#htu21_dew").removeClass("is-invalid").html(),$("#htu21_dew").removeClass("is-valid").html(),$("#htu21_dew").addClass("is-invalid").html(),$("#htu21_pp").removeClass("is-invalid").html(),$("#htu21_pp").removeClass("is-valid").html(),$("#htu21_pp").addClass("is-invalid").html();$("#htu21_dew").removeClass("is-invalid").html();$("#htu21_dew").removeClass("is-valid").html();
$("#htu21_dew").addClass("is-valid").html();$("#htu21_pp").removeClass("is-invalid").html();$("#htu21_pp").removeClass("is-valid").html();$("#htu21_pp").addClass("is-valid").html();temp_json.debug&&("ON"==temp_json.debug?(sdmc_sh(),d.removeClass("badge-warning"),d.addClass("badge-success"),d.text("\u0412\u041a\u041b")):"OFF"==temp_json.debug?(sdmc_rm(),d.removeClass("badge-success"),d.addClass("badge-warning"),d.text("\u0412\u042b\u041a\u041b")):(d.removeClass("badge-success"),d.addClass("badge-danger"),
d.text("\u041d\u0415\u0422 \u0421\u0412\u042f\u0417\u0418")),$(".swdeb").removeAttr("disabled"));if(temp_json.rtc_get){c=0;for(c in temp_json.rtc_get)str_out+=temp_json.rtc_get[c]+"-";$(".ptime").text(str_out.substring(0,str_out.length-1))}str_out=""}function tmpvlon(b){$("#"+maOBJ[b].name).removeClass("is-invalid").html();$("#"+maOBJ[b].name).removeClass("is-valid").html();$("#"+maOBJ[b].name).addClass("is-valid").html()}
function tmpvloff(b){$("#"+maOBJ[b].name).removeClass("is-invalid").html();$("#"+maOBJ[b].name).removeClass("is-valid").html();$("#"+maOBJ[b].name).addClass("is-invalid").html()}function sdmc_sh(){mds.removeClass("collapse show");mds.addClass("collapse hide");sds.removeClass("collapse hide");sds.addClass("collapse show");sets.removeClass("collapse hide");sets.addClass("collapse show")}
function sdmc_rm(){mds.removeClass("collapse hide");mds.addClass("collapse show");sds.removeClass("collapse show");sds.addClass("collapse hide");sets.removeClass("collapse show");sets.addClass("collapse hide")}function ftvall(b){for(i=0;i<maOBJ.length;i++)$("#"+maOBJ[i].name).val(b),$("#"+maOBJ[i].name).removeClass("is-invalid").html(),$("#"+maOBJ[i].name).removeClass("is-valid").html()}
function ftmpd(){for(i=0;i<maOBJ.length;i++)$("#"+maOBJ[i].name).removeClass("is-invalid").html(),$("#"+maOBJ[i].name).removeClass("is-valid").html()}function spt0(){return $("#esp_tx").val().replace(/^[\n]+$/g,"").split(/[\n]+/)}function smgh(){device.mobile()||$(".bt0st").click()}$(".bt0st1").click(function(){$(".bt0st").click()});function erxclr_uart(){$("#esp_tx").val("")}function etxclr_uart(){$("#esp_urx").val("");str_out1=""}
$(".bt0st").click(function(){ast=$(".bt0st").attr("value");device.mobile()?"on"!=ast?($(".bt0st").attr("value","on"),rm_b(),rms_b(),shs_b()):($(".bt0st").attr("value","off"),rm_b(),rms_b(),sh_b()):"on"!=ast?($(".bt0st").attr("value","on"),rm_b(),sh_b()):($(".bt0st").attr("value","off"),rm_b())});function rm_b(){$(".mc1").removeClass("col-md-8 col-xl-8").html();$(".bsn0").removeClass("col-md-4 col-xl-4").html();$(".mc1").removeClass("noscroll collapse hide");$(".mc1").addClass("col-12").html()}
function sh_b(){$(".mc1").remove("col-12").html();$(".mc1").addClass("col-md-8 col-xl-8").html();$(".bsn0").addClass("col-md-4 col-xl-4").html()}function rms_b(){$(".bsn0").removeClass("col-12 overlay").html();$(".mc1").removeClass("noscroll collapse hide")}function shs_b(){$(".bsn0").addClass("col-12 overlay").html();$(".mc1").addClass("noscroll collapse hide").html()}
...
function fetch(b,g,d,e){var a=new XMLHttpRequest;a.onloadend=function(){d(a.status,a.responseText)};a.ontimeout=function(){d(-1,null)};a.open(g,b,!0);a.setRequestHeader("Accept","application/json");a.timeout=200*e;a.send()}function btn_lm75_1s(){$(".btns_lm75_1").removeClass("badge-danger");$(".btns_lm75_1").removeClass("badge-success");fetch("/output_lm75_1.json?n="+Math.random(),"GET",txjstmp,10)}
...
function btn_lm75_1(){var b,g=0,d=$("#lm75sc_1"),e=$("#lm75so_1");for(b=0;5>b&&void 0!=$("#gLM75ch"+b).val();++b)$("#gLM75ch"+b).prop("checked")&&(g|=1<<b);var a=d.val();var f=e.val();f>a&&0>f&&0>a?a=f=a:f>a&&(b=f,f=a,a=b);a==f&&(0>f&&0>a?f--:a++);d.val(f);e.val(a);$(".lm75thy_1").text(d.val()+" C\u00b0");$(".lm75tos_1").text(e.val()+" C\u00b0");f=parseInt(d.val());a=parseInt(e.val());fetch("/input_lm75_1.json?n="+encodeURIComponent(JSON.stringify({lm75_conf:[g,2*f,2*a]}))+"&","GET",txjstmp,10)}
function btn_lm75_2(){var b,g=0,d=$("#lm75sc_2"),e=$("#lm75so_2");for(b=0;5>b&&void 0!=$("#gLM752ch"+b).val();++b)$("#gLM752ch"+b).prop("checked")&&(g|=1<<b);var a=d.val();var f=e.val();f>a&&0>f&&0>a?a=f=a:f>a&&(b=f,f=a,a=b);a==f&&(0>f&&0>a?f--:a++);d.val(f);e.val(a);$(".lm75thy_2").text(d.val()+" C\u00b0");$(".lm75tos_2").text(e.val()+" C\u00b0");f=parseInt(d.val());a=parseInt(e.val());fetch("/input_lm75_2.json?n="+encodeURIComponent(JSON.stringify({lm75_conf:[g,2*f,2*a]}))+"&","GET",txjstmp,10)}
function sub_grad(){maOBJ=$("#tmpo").serializeArray();fetch("/temp_out.json?n="+Math.random(),"GET",txjstmp,10)}
