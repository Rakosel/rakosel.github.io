...
function txjstmp(a,g){var c=$(".pst1"),f=$(".pst0"),b=0,d=0,k=0,m=0,n=0,p=0,r=1,t=1,u=1;if(200!=a)return f.removeClass("badge-success"),f.addClass("badge-danger"),f.text("\u041d\u0435\u0442 \u0441\u0432\u044f\u0437\u0438"),c.removeClass("badge-success"),c.addClass("badge-danger"),c.text("\u041d\u0435\u0442 \u0441\u0432\u044f\u0437\u0438"),$(".swdeb").removeAttr("disabled"),ftmpd(),console.log("Connection proplem!"),0;f.removeClass("badge-danger");c.removeClass("badge-danger");f.addClass("badge-success");
c.addClass("badge-success");f.text("\u041e\u041a ");c.text("\u041e\u041a ");if("string"===typeof g)try{temp_json=JSON.parse(g),console.log(a,temp_json)}catch(q){return ftvall(""),console.log(a,q.message),0}else return console.log("d not string"),ftvall(""),0;if(temp_json.LM75_CMP)try{var e=parseInt(temp_json.LM75_CMP[0].trim(),10),h=parseInt(temp_json.LM75_CMP[1].trim(),10);1==e?$("#lm75_t1_chk").prop("checked",!0):$("#lm75_t1_chk").prop("checked",!1);1==h?$("#lm75_t2_chk").prop("checked",!0):$("#lm75_t2_chk").prop("checked",
!1)}catch(q){console.log(q)}temp_json.lm_75_1_cb&&("OK"==temp_json.lm_75_1_cb?$(".btns_lm75_1").addClass("badge-success").text("\u041e\u041a "):$(".btns_lm75_1").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 "));if(temp_json.lm75_1_ou)if(999!=parseInt(temp_json.lm75_1_ou[1].trim(),10)||999!=parseInt(temp_json.lm75_1_ou[0].trim(),10)){e=parseInt(temp_json.lm75_1_ou[1].trim(),10);h=parseInt(temp_json.lm75_1_ou[2].trim(),10);$(".lm75thy_1").text(e+" \u00b0C");$(".lm75tos_1").text(h+
...
temp_json.bme280_2_ou[3]+"]").prop("selected","selected"),$("#bm2s_f [value="+temp_json.bme280_2_ou[4]+"]").prop("selected","selected"),$("#bm2_t_st [value="+temp_json.bme280_2_ou[5]+"]").prop("selected","selected"),$(".btns_bme280_2").addClass("badge-success").text("\u041e\u041a "))):($("#bm2_ch").val("\u041e\u0448\u0438\u0431\u043a\u0430"),$("#bm2_st").val("\u041e\u0448\u0438\u0431\u043a\u0430"),$(".btns_bme280_2").addClass("badge-danger").text("\u041e\u0448\u0438\u0431\u043a\u0430 ")));if(temp_json.temp){for(e=
3;e<=maOBJ.length&&e-3<=temp_json.temp.length;e++)"#ERR"==temp_json.temp[e-3]||""==temp_json.temp[e-3]||temp_json.temp[e-3]==isNaN()?tmpvloff(e):tmpvlon(e),$("#"+maOBJ[e].name).val(temp_json.temp[e-3]);for(e=3;e<=maOBJ.length&&e-3<=temp_json.temp.length;e++)if("#ERR"!=temp_json.temp[e-3]||""!=temp_json.temp[e-3]||temp_json.temp[e-3]!=isNaN())m<=T_arr.length&&(b+=temp_json.temp[0],r++,m++),n<=H_arr.length&&(d+=temp_json.temp[0],t++,n++),p<=P_arr.length&&(k+=temp_json.temp[0],u++,p++);$("#temperature").val(b/
m);$("#humudity").val(d/n);$("#pressure").val(k/p)}$("#tm_adc").removeClass("is-invalid").html();$("#tm_adc").removeClass("is-valid").html();temp_json.temt_adc&&($("#tm_adc").val(temp_json.temt_adc),""==temp_json.temt_adc||temp_json.temt_adc==isNaN()?$("#tm_adc").addClass("is-invalid").html():$("#tm_adc").addClass("is-valid").html());d=parseFloat($("#htu21_t").val());b=parseFloat($("#htu21_h").val());k=1.359*Math.pow(10,8)*Math.pow(10,-1762.39/(d+235.66));d=(133.32*k/1E3).toString();$("#htu21_pp").val(d.substring(0,
5));b=(-(1762.39/(Math.log(.01*b*k)-8.1332)+235.66)).toString();$("#htu21_dew").val(b.substring(0,5));if("NaN"==d||"NaN"==b||""==d||""==b)$("#htu21_dew").removeClass("is-invalid").html(),$("#htu21_dew").removeClass("is-valid").html(),$("#htu21_dew").addClass("is-invalid").html(),$("#htu21_pp").removeClass("is-invalid").html(),$("#htu21_pp").removeClass("is-valid").html(),$("#htu21_pp").addClass("is-invalid").html();$("#htu21_dew").removeClass("is-invalid").html();$("#htu21_dew").removeClass("is-valid").html();
...
c.addClass("badge-danger"),c.text("\u041d\u0415\u0422 \u0421\u0412\u042f\u0417\u0418")),$(".swdeb").removeAttr("disabled"));if(temp_json.rtc_get){e=0;for(e in temp_json.rtc_get)str_out+=temp_json.rtc_get[e]+"-";$(".ptime").text(str_out.substring(0,str_out.length-1))}str_out=""}function tmpvlon(a){$("#"+maOBJ[a].name).removeClass("is-invalid").html();$("#"+maOBJ[a].name).removeClass("is-valid").html();$("#"+maOBJ[a].name).addClass("is-valid").html()}
