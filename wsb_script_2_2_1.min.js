// upd79a1 STABLE trim with upravl timer	https://rakosel.github.io/wsb_script_2_2_1.js
// 682 stroka trim ???
// except (
    ...
    if (temp_json["temp"]) {
        ...
        for (i = 0; i <= temp_json.temp.length; i++) {
            //try {
				...
				{
					j_P+=val(temp_json.temp[i].);P_cnt++;
				}	
        }
		console.log(+"a3 "+j_T+" "+j_H+" "+j_P+" "+T_cnt+" "+H_cnt+" "+P_cnt);
