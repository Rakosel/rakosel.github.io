// upd1c3 light_version	https://rakosel.github.io/wsb_script_2_2_1.min.js
//
...
//  })
	...
	var url1 = "/input_bme280_2.json?=" + encodeURIComponent(newPost) + "&";
    fetch1(url1, "GET", txjstmp, 10);
	
	url1 = "/input_bme280_2.json?n=" + encodeURIComponent(JSON.stringify(newPost)) + "&";
	fetch1(url1, "GET", txjstmp, 10);
