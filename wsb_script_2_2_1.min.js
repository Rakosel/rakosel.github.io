...
h=0>k?-1:h*h,j_T+=Math.abs(k),c++),e<H_arr.length&&NaN!=parseFloat(temp_json.temp[H_arr[e]])&&!(99<=parseFloat(temp_json.temp[H_arr[e]]))&&(j_H=3==H_arr[e]?j_H+(parseFloat(temp_json.temp[H_arr[e]])-9.5):j_H+parseFloat(temp_json.temp[H_arr[e]]),f++),e<P_arr.length&&NaN!=parseFloat(temp_json.temp[P_arr[e]])&&(j_P+=parseFloat(temp_json.temp[P_arr[e]]),l++),e++),$("#"+maOBJ[a].name).val(temp_json.temp[a-3]);j_T=j_T*h/c;j_H/=f;j_P/=l}NaN==j_T?tmpvloff(0):tmpvlon(0);NaN==j_P?tmpvloff(1):tmpvlon(1);NaN==
j_H?tmpvloff(2):tmpvlon(2);$("#tm_adc").removeClass("is-invalid").html();$("#tm_adc").removeClass("is-valid").html();temp_json.temt_adc&&($("#tm_adc").val(temp_json.temt_adc),""==temp_json.temt_adc||"#ERR"==temp_json.temt_adc?$("#tm_adc").addClass("is-invalid").html():$("#tm_adc").addClass("is-valid").html());h=parseFloat($("#htu21_t").val());a=parseFloat($("#htu21_h").val());e=1.359*Math.pow(10,8)*Math.pow(10,-1762.39/(h+235.66));h=(133.32*e/1E3).toString();$("#htu21_pp").val(h.substring(0,5));a=
(-(1762.39/(Math.log(.01*a*e)-8.1332)+235.66)).toString();$("#htu21_dew").val(a.substring(0,5));if("NaN"==h||"NaN"==a||""==h||""==a)$("#htu21_dew").removeClass("is-invalid").html(),$("#htu21_dew").removeClass("is-valid").html(),$("#htu21_dew").addClass("is-invalid").html(),$("#htu21_pp").removeClass("is-invalid").html(),$("#htu21_pp").removeClass("is-valid").html(),$("#htu21_pp").addClass("is-invalid").html();$("#htu21_dew").removeClass("is-invalid").html();$("#htu21_dew").removeClass("is-valid").html();
...
d.text("\u041d\u0415\u0422 \u0421\u0412\u042f\u0417\u0418")),$(".swdeb").removeAttr("disabled"));if(temp_json.rtc_get){a=0;for(a in temp_json.rtc_get)str_out+=temp_json.rtc_get[a]+"-";$(".ptime").text(str_out.substring(0,str_out.length-1))}str_out=""}function tmpvlon(b){$("#"+maOBJ[b].name).removeClass("is-invalid").html();$("#"+maOBJ[b].name).removeClass("is-valid").html();$("#"+maOBJ[b].name).addClass("is-valid").html()}
